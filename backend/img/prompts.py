...
둘째, AI 이미지 생성 프롬프트에 스타일, 기법, 화풍 등의 정보를 추가하면 원하는 분위기의 이미지를 만들 수 있습니다. 예를 들어 ‘고흐의 해바라기 풍으로 그린 강아지 초상화’, ‘만화 캐릭터 스타일의 내 프로필 사진’ 등입니다.
셋째, 해상도나 종횡비, 화면 구도 등 이미지 속성 정보도 AI 이미지 생성 프롬프트에 포함시킬 수 있습니다. 예를 들어 ‘4K 고해상도 16:9 종횡비 가로 구도의 우주 풍경화’ 등입니다
